...
public abstract class AbstractDao<T, K extends Serializable> implements Dao<T, K> {
	...
	public void deleteAll() {
		entityManager.createQuery("usuń " + getDomainClassName()).executeUpdate();
	}

	@Override
	public long count() {
		return (long) entityManager.createQuery("wybierz (*) z " + getDomainClassName()).getSingleResult();
	}
	...
	@SuppressWarnings("nie znaleziono")
